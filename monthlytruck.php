...
$query = "SELECT * FROM `track` WHERE MONTH(`datetime`) = '$m' AND YEAR(`datetime`) = '$y' ORDER BY `datetime` DESC LIMIT $Page_Start , $Per_Page";
$objQuery = mysqli_query($conn, "SELECT * FROM `track` WHERE MONTH(`datetime`) = '$m' AND YEAR(`datetime`) = '$y' ");
