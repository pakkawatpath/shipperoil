...
$query = "SELECT * FROM `pipeline` WHERE MONTH(`datetime`) = '$m' AND YEAR(`datetime`) = '$y' ORDER BY `datetime` DESC LIMIT $Page_Start , $Per_Page";
$objQuery = mysqli_query($conn, "SELECT * FROM `pipeline` WHERE MONTH(`datetime`) = '$m' AND YEAR(`datetime`) = '$y'");
