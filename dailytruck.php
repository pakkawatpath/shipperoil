...
$query = "SELECT * FROM `track` WHERE date(`datetime`) = '$date' ORDER BY `datetime` DESC LIMIT $Page_Start , $Per_Page";
$objQuery = mysqli_query($conn, "SELECT * FROM `track` WHERE date(`datetime`) = '$date' ");
